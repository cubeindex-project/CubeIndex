...
| Version           | Supported          |
| ----------------- | ------------------ |
| Latest deployment | :white_check_mark: |
| Older deployments | :x:                |
...
Instead, report it privately through the [GitHub Security Advisories](https://github.com/cubeindex-project/CubeIndex/security/advisories) page:
