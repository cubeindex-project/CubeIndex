...
export type Database = {
  ...
  public: {
    Tables: {
      accessories: {
        Row: {
          approved: boolean
          brand: string | null
          category: Database["public"]["Enums"]["accessories_categories"] | null
      ...
      cube_models: {
        Row: {
          ...
          release_date_precision: Database["public"]["Enums"]["date_precision"]
      ...
      vendors: {
        ...
        Relationships: [
          {
            foreignKeyName: "vendors_submitted_by_id_fkey"
            columns: ["submitted_by_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
          ...
          {
            foreignKeyName: "vendors_verified_by_id_fkey"
            columns: ["verified_by_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
    ...
    Views: {
      ...
      v_detailed_cube_models: {
        Row: {
          ...
          verified_at: string | null
          verified_by_id: string | null
          version_type: Database["public"]["Enums"]["cube_version_types"] | null
      ...
      v_detailed_vendors: {
        Row: {
          ...
          status: Database["public"]["Enums"]["submission_status"] | null
          submitted_by_id: string | null
          supports_price_scraping: boolean | null
          supports_product_scraping: boolean | null
          updated_at: string | null
          verified_at: string | null
          verified_by_id: string | null
        }
    ...
    Enums: {
      ...
      cube_version_types: "Base" | "Variant" | "Limited"
      cubes_subtypes:
        | "NxNxN"
        | "Square-N"
        | "Minx"
