        ...
        {:else}
          ...
          >
            <div class="card-body space-y-6">
              ...
              >
                <div class="space-y-2">
                  ...
                  <p class="text-sm text-base-content/70">
                    ...
                    background import, normalize specs, and draft the submission
                    for you.
                  </p>
                  <p class="text-xs text-base-content/60">
                    Keep each request focused on one cube. Use different shops
                    for the same model so we can cross-check pricing and specs.
                  </p>
                  <p class="text-xs text-base-content/60">
              ...
              >
                A background job fetches the product pages, extracts specs, and
                lets you review the draft before publishing.
              </div>
              ...
              <div class="space-y-3 border-t border-base-200 pt-4">
                ...
                {:else}
                  <p class="text-sm text-base-content/60">
                    No automated imports yet. Paste a few product links to kick
                    things off.
                  </p>
                {/if}
              </div>
