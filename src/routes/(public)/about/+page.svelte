...
<section class="min-h-screen px-6 py-24 relative overflow-hidden">
  <div class="relative z-10 max-w-4xl mx-auto space-y-12 text-center">
    ...
    <div>
      ...
      <p class="text-lg">
        CubeIndex is your all-in-one hub for speedcubing — whether you're a
        seasoned solver, beginner, or collector.
      </p>
    </div>
    ...
    <div class="mt-12">
      ...
      <p class="mt-2">
        ...
        <a href="/discord" target="_blank" class="link link-primary link-hover"
          >Discord</a
        >.
      </p>
    </div>
