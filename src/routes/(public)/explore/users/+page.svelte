...
<section class="min-h-screen bg-black text-white px-4 py-12">
  <div class="max-w-4xl mx-auto">
    <h1 class="text-4xl font-clash font-bold mb-10 text-center">Explore Users</h1>
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            <div class="flex flex-col gap-0.5">
              <span class="font-semibold text-base group-hover:text-blue-400 truncate">{profile.username}</span>
          ...
          <span class="ml-2 text-blue-500 group-hover:translate-x-1 transition-transform">
