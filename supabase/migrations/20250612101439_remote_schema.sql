...
CREATE TABLE IF NOT EXISTS "public"."achievements" (
    ...
    "unlock_method" "text" DEFAULT 'manual'::"text" NOT NULL,
    "submitted_by" "text",
...
ALTER TABLE "public"."user_ratings" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."user_ratings_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."user_roles"
    ADD CONSTRAINT "user_roles_user_fkey" FOREIGN KEY ("user") REFERENCES "public"."profiles"("username") ON UPDATE CASCADE ON DELETE CASCADE;
...
GRANT ALL ON SEQUENCE "public"."user_achievement_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."user_achievement_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."user_achievement_id_seq" TO "service_role";
