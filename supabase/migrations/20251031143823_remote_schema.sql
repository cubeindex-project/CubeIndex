...
CREATE TABLE IF NOT EXISTS "public"."cube_scrap_runs_url" (
    "id" bigint NOT NULL,
...
ALTER TABLE "public"."cube_scrap_runs_url" OWNER TO "postgres";


ALTER TABLE "public"."cube_scrap_runs_url" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."cube_scrap_runs_url_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."cube_scrap_runs_url"
    ADD CONSTRAINT "cube_scrap_runs_url_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."cube_scrap_runs_url"
    ADD CONSTRAINT "cube_scrap_runs_url_run_id_fkey" FOREIGN KEY ("run_id") REFERENCES "public"."cube_scrap_runs"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."cube_scrap_runs_url" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable read access for authenticated users" ON "public"."cube_scrap_runs_url" FOR SELECT TO "authenticated" USING (true);
...
ALTER TABLE "public"."cube_scrap_runs_url" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."cube_scrap_runs_url" TO "anon";
GRANT ALL ON TABLE "public"."cube_scrap_runs_url" TO "authenticated";
GRANT ALL ON TABLE "public"."cube_scrap_runs_url" TO "service_role";



GRANT ALL ON SEQUENCE "public"."cube_scrap_runs_url_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."cube_scrap_runs_url_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."cube_scrap_runs_url_id_seq" TO "service_role";
...
alter table "public"."cube_scrap_runs_url" drop constraint "cube_scrap_runs_url_run_id_fkey";
...
alter table "public"."cube_scrap_runs_url" add constraint "cube_scrap_runs_url_run_id_fkey" FOREIGN KEY (run_id) REFERENCES public.cube_scrap_runs(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."cube_scrap_runs_url" validate constraint "cube_scrap_runs_url_run_id_fkey";
