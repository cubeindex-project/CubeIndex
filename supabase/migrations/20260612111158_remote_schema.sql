...
CREATE TYPE "public"."cube_review_status" AS ENUM (
    'published',
    'draft',
    'hidden'
);
...
ALTER TYPE "public"."cube_review_status" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."awards_user_vote_achi_check"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$begin
insert into
  user_achievements (achievement_slug, user_id)
values
  ('awards-pioneer', auth.uid ())
...
ALTER FUNCTION "public"."awards_user_vote_achi_check"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."helpful_review" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."helpful_review" OWNER TO "postgres";


ALTER TABLE "public"."helpful_review" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."helpful_review_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."user_cube_reviews" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "review" "text" NOT NULL,
    "status" "public"."cube_review_status" DEFAULT 'draft'::"public"."cube_review_status" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "cube" "text" NOT NULL,
    "title" "text" NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
...
ALTER TABLE "public"."user_cube_reviews" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."user_cube_reviews_categories" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "slug" "text" NOT NULL,
    "label" "text" NOT NULL,
...
ALTER TABLE "public"."user_cube_reviews_categories" OWNER TO "postgres";


ALTER TABLE "public"."user_cube_reviews_categories" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."user_cube_reviews_categories_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."user_cube_reviews" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."user_cube_reviews_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."user_cube_reviews_ratings" (
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "review_id" bigint NOT NULL,
    "category_id" bigint NOT NULL,
    "rating" real NOT NULL,
    CONSTRAINT "user_cube_reviews_ratings_rating_check" CHECK ((("rating" >= (0.5)::double precision) AND ("rating" <= (5)::double precision)))
);


ALTER TABLE "public"."user_cube_reviews_ratings" OWNER TO "postgres";
...
ALTER TABLE "public"."user_cubes" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."user_cubes_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."vendors" (
    ...
    "logo_url" "text",
    "currency" "public"."currencies" DEFAULT 'USD'::"public"."currencies" NOT NULL,
...
CREATE OR REPLACE VIEW "public"."v_detailed_user_cube_reviews" WITH ("security_invoker"='on') AS
 WITH "ratings" AS (
...
ALTER TABLE "public"."v_detailed_user_cube_reviews" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."v_detailed_vendors" WITH ("security_invoker"='on') AS
 SELECT "v"."id",
    "v"."slug",
    "v"."created_at",
    "v"."name",
...
ALTER TABLE "public"."v_detailed_vendors" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."v_price_history" WITH ("security_invoker"='on') AS
 WITH "daily_rows" AS (
...
ALTER TABLE "public"."v_price_history" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."v_user_stats" WITH ("security_invoker"='on') AS
 WITH "cube_stats" AS (
         SELECT "uc"."user_id",
            "count"(*) AS "cube_count",
...
ALTER TABLE "public"."v_user_stats" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."user_cube_reviews"
    ADD CONSTRAINT "cube_reviews_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."helpful_review"
    ADD CONSTRAINT "helpful_review_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."user_cube_reviews_categories"
    ADD CONSTRAINT "user_cube_reviews_categories_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."user_cube_reviews_ratings"
    ADD CONSTRAINT "user_cube_reviews_ratings_pkey" PRIMARY KEY ("review_id", "category_id");
...
CREATE OR REPLACE TRIGGER "trig_awards_user_vote_achi_check" AFTER INSERT ON "public"."awards_user_vote" FOR EACH ROW EXECUTE FUNCTION "public"."awards_user_vote_achi_check"();
...
ALTER TABLE ONLY "public"."helpful_review"
    ADD CONSTRAINT "helpful_review_review_id_fkey" FOREIGN KEY ("review_id") REFERENCES "public"."user_cube_reviews"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."helpful_review"
    ADD CONSTRAINT "helpful_review_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("user_id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_cube_reviews_ratings"
    ADD CONSTRAINT "user_cube_reviews_ratings_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."user_cube_reviews_categories"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_cube_reviews_ratings"
    ADD CONSTRAINT "user_cube_reviews_ratings_review_id_fkey" FOREIGN KEY ("review_id") REFERENCES "public"."user_cube_reviews"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_cube_reviews"
    ADD CONSTRAINT "user_cube_reviews_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("user_id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."helpful_review" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."user_cube_reviews_ratings" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable insert for users based on user_id" ON "public"."helpful_review" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable insert for users based on user_id" ON "public"."user_cube_reviews" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Enable read access for all users" ON "public"."awards_user_vote" FOR SELECT USING (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."helpful_review" FOR SELECT USING (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."user_cube_reviews" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."user_cube_reviews_categories" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."user_cube_reviews_ratings" FOR SELECT USING (true);
...
CREATE POLICY "Enable update for users based on user_id" ON "public"."user_cube_reviews" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable update for users own reviews ratings" ON "public"."user_cube_reviews_ratings" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_cube_reviews" "ucr"
  WHERE (("ucr"."id" = "user_cube_reviews_ratings"."review_id") AND ("ucr"."user_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_cube_reviews" "ucr"
...
GRANT ALL ON FUNCTION "public"."awards_user_vote_achi_check"() TO "anon";
GRANT ALL ON FUNCTION "public"."awards_user_vote_achi_check"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."awards_user_vote_achi_check"() TO "service_role";
...
GRANT ALL ON TABLE "public"."helpful_review" TO "anon";
GRANT ALL ON TABLE "public"."helpful_review" TO "authenticated";
GRANT ALL ON TABLE "public"."helpful_review" TO "service_role";



GRANT ALL ON SEQUENCE "public"."helpful_review_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."helpful_review_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."helpful_review_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."user_cube_reviews" TO "anon";
GRANT ALL ON TABLE "public"."user_cube_reviews" TO "authenticated";
GRANT ALL ON TABLE "public"."user_cube_reviews" TO "service_role";



GRANT ALL ON TABLE "public"."user_cube_reviews_categories" TO "anon";
GRANT ALL ON TABLE "public"."user_cube_reviews_categories" TO "authenticated";
GRANT ALL ON TABLE "public"."user_cube_reviews_categories" TO "service_role";



GRANT ALL ON SEQUENCE "public"."user_cube_reviews_categories_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."user_cube_reviews_categories_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."user_cube_reviews_categories_id_seq" TO "service_role";



GRANT ALL ON SEQUENCE "public"."user_cube_reviews_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."user_cube_reviews_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."user_cube_reviews_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."user_cube_reviews_ratings" TO "anon";
GRANT ALL ON TABLE "public"."user_cube_reviews_ratings" TO "authenticated";
GRANT ALL ON TABLE "public"."user_cube_reviews_ratings" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."user_cubes_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."user_cubes_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."user_cubes_id_seq" TO "service_role";
...
GRANT ALL ON TABLE "public"."v_detailed_user_cube_reviews" TO "anon";
GRANT ALL ON TABLE "public"."v_detailed_user_cube_reviews" TO "authenticated";
GRANT ALL ON TABLE "public"."v_detailed_user_cube_reviews" TO "service_role";



GRANT ALL ON TABLE "public"."v_detailed_vendors" TO "anon";
GRANT ALL ON TABLE "public"."v_detailed_vendors" TO "authenticated";
GRANT ALL ON TABLE "public"."v_detailed_vendors" TO "service_role";
