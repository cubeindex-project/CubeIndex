...
alter table "public"."user_cubes" add column "purchase_price_currency" text;

alter table "public"."user_cubes" alter column "purchase_price" set data type numeric(12,2) using "purchase_price"::numeric(12,2);

CREATE UNIQUE INDEX user_cube_ratings_cube_id_user_id_unique ON public.user_cube_ratings USING btree (cube_id, user_id);

CREATE UNIQUE INDEX user_cube_ratings_pkey ON public.user_cube_ratings USING btree (id);

CREATE UNIQUE INDEX user_cubes_cube_id_user_id_unique ON public.user_cubes USING btree (cube_id, user_id);

CREATE UNIQUE INDEX user_cubes_pkey ON public.user_cubes USING btree (id);
...
alter table "public"."user_cube_ratings" add constraint "user_cube_ratings_cube_id_user_id_unique" UNIQUE using index "user_cube_ratings_cube_id_user_id_unique";

alter table "public"."user_cubes" add constraint "user_cubes_cube_id_user_id_unique" UNIQUE using index "user_cubes_cube_id_user_id_unique";

alter table "public"."user_cubes" add constraint "user_cubes_currency_check" CHECK ((purchase_price_currency ~ '^[A-Z]{3}$'::text)) not valid;
